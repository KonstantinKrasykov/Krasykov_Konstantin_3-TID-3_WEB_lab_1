...
var previewBoxes = document.querySelectorAll('.previewBox');
var bigColorBox = document.querySelector('.bigColorBox');
...
function updateColors() {
  var lighter1 = adjustColor(mainColor, 64);
  var lighter2 = adjustColor(mainColor, 115);
  var darker1 = adjustColor(mainColor, -50);
  var darker2 = adjustColor(mainColor, -89);
  ...
  bigColorBox.style.backgroundColor = mainColor;
